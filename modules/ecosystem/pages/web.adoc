...
- https://jquery.com/[jQuery]: Muy usado en principios de la década del 2010, hoy no tanto.
- https://alpinejs.dev/[Alpine.js]: Una versión más simple de manipular el DOM sin necesidad de frameworks más grandes como React.
- https://react.dev/[React] (https://nextjs.org/[Next.js]): Framework muy usado actualmente.
- https://angular.dev/[Angular] (https://nestjs.com/[Nest.js]): Popular para aplicaciones con Springboot.
- https://vuejs.org/[Vue]: Popular en aplicaciones con Laravel.
- https://svelte.dev/[Svelte]: Una excelente alternativa a React, Vue y Angular que combina múltiples ideas de cada uno.
...
- https://inertiajs.com/[Inertia.js] (Laravel, Rails)
- https://htmx.org/[HTMX] (Go, Java).
...
- https://hotwired.dev/[Hotwire] (Ruby)
- https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor[Blazor] (C#)
...
Los frameworks que impulsaron este ecosistema son Ruby on Rails y Django. Ambos fueron los pioneros en la forma
de estructurar los proyectos y herramientas anexas (como la línea de comandos) que permitieron y dieron inspiración
a frameworks actuales como Laravel y Phoenix.
...
| https://docs.masoniteproject.com/[Masonite] | Framework similar a Laravel pero hecho en Python.
...
| https://laravel.com/[Laravel] | Framework más popular de PHP, similar a Rails en muchos aspectos.
| https://symfony.com/[Symphony] | Conjunto de componentes y framework web. Laravel utiliza mucho de sus componentes.
| https://phalcon.io[Phalcon] | Framework de PHP creado como extensión del lenguaje para mayor velocidad.
|====
...
| https://www.goravel.dev/[Goravel] | Framework de Go muy similar a Laravel.
| https://gobuffalo.io/[Buffalo] | Conjunto de componentes y framework web en Go.
| https://gofiber.io/[Fiber] | Framework más liviano pensado para APIs.
|====
...
| https://rwsdk.com/[Redwood SDK] | Framework fullstack recomendado para Javascript.
| https://expressjs.com/[Express] | Framework más conocido para APIs en Javascript, aunque existen alternativas más modernas como Koa.
| https://koajs.com/[Koa.js] | Framework para APIs en Javascript.
|====
...
| https://vapor.codes/[Vapor.code] | Framework más popular para backends con Swift.
|====
...
| https://spring.io/projects/spring-boot[Springboot] | Framework más popular para Java. Usado comunmente como alternativa a ASP.net por empresas grandes como bancos. Normalmente emparejado con Angular.

| https://www.dropwizard.io/en/stable/[Dropwizard] | Framework para backends restful con herramientas preseleccionadas sólidas.

| https://sparkjava.com/[Spark]| Framework más liviano que Springboot, pensado para Kotlin y Java. Similar a frameworks como ExpressJS.

| https://ktor.io/[Ktor] | Framework web pensado para Kotlin.
|====
...
| https://dotnet.microsoft.com/en-us/apps/aspnet[ASP.NET Core] | El framework oficial de Microsoft para crear aplicaciones y servicios web con .NET y C#.
| https://es.wikipedia.org/wiki/ASP.NET_MVC_Framework[ASP.NET MVC]| Versión anterior de ASP.NET Core, la cual era exclusiva de Windows. Si bien fue reemplazada por ASP.NET Core, muchas empresas todavía la usan en sus proyectos legacy. 
|====
...
|PETaL | Phoenix, Postgres, Elixir, Tailwind, LiveView. Stack utilizado en la mayoría de los proyectos con Elixir. Se podría añadir también https://ash-hq.org/[Ash Framework] como una capa de abastracción para la gestión de recursos de datos.
...
- https://wordpress.org/[Wordpress]: CMS popular para la creación de sitios web informativos como blogs. Se puede encontrar múltiples plantillas gratuitas y de pago para armar sitios web rápidamente. Pero se vuelve engorroso al poco tiempo.
- https://processwire.com/[ProcessWire]: Excelente alternativa a Wordpress cuando se necesita mayor nivel de personalización y control.

== Servidores Web

- https://httpd.apache.org/[Apache2]: Servidor popular con aplicaciones PHP como Wordpress.
- https://github.com/erlyaws/yaws[Yaws]: Una alternativa similar a Apache2 pero desarrollada en Erlang.
- https://nginx.org/[Nginx]: Servidor muy popular como proxy reverso y servir archivos estáticos.
- https://github.com/monkey/monkey[Monkey HTTP]: Servidor web creado en Chile.

== Backend as a Service

- https://firebase.google.com/?hl=es-419[Firebase]: Servidor todo en uno, principalmente para aplicaciones móviles.
- https://supabase.com/[Supabase]: Gestión de base de datos, excelente alternativa a firebase.
...
Se recomienda seleccionar un stack y profundizarlo mínimo 2 años. 
Esto permitirá ganar experiencia y conocer tanto sus fortalezas
como sus debilidades. Lo ideal es tener almenos un framework backend
y un framework frontend dominado para poder abarcar mayor número de ofertas laborales.
