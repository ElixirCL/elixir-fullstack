...
React.js es un framework de frontend en Javascript, tal cual es Vue.js, Svelte o Angular.
Sin embargo ha ganado una notable popularidad tanto en la comunidad de Javascript como 
en la comunidad de Elixir, por lo que es probable encontrar muchos proyectos 
