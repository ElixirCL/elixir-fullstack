defmodule StoicQuotesWeb.Router do
  ...
  scope "/gql" do
    ...
    forward("/playground", Absinthe.Plug.GraphiQL,
      schema: Module.concat(["StoicQuotesWeb.GraphqlSchema"]),
      socket: Module.concat(["StoicQuotesWeb.GraphqlSocket"]),
      interface: :simple
    )

    forward("/", Absinthe.Plug, schema: Module.concat(["StoicQuotesWeb.GraphqlSchema"]))
  end
