{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/lekkice/code/elixir/stoic";
devenv_dotfile = "/home/lekkice/code/elixir/stoic/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-3dba234";
...
hostname = "lekk";
username = "lekkice";
git_root = "/home/lekkice/code/elixir/stoic";
